...
def generate_ORBsignature(img_path):
    ...
    keypoints = orb.detect(image2,None)
    ...
    cv2.imwrite("nr2/image_1castleORB.jpg", image) 
...
sig1 = generate_ORBsignature(path1)
#sig2 = generate_ORBsignature(path2)
#sig3 = generate_ORBsignature(path3)
#sig4 = generate_ORBsignature(path4)
#
