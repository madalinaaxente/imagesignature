...
def generate_SIFTsignature(img_path):
...
#sig1 = generate_SIFTsignature(path1)
#sig2 = generate_SIFTsignature(path2)
#sig3 = generate_SIFTsignature(path3)
#sig4 = generate_SIFTsignature(path4)
#
